...
#auxiliary module, may be able to put in a separate file
class SEBlock(nn.Module):
    """Squeeze Excitation Block,the “Squeeze-and-Excitation” (SE) block, that adaptively recalibrates channel-wise 
...
class RepVGGBlock(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size,
        ...
        assert padding == 1,"this padding to keep the input feature map size equal to the output size"
...
class RepVGG(nn.Module):
    ...
    def __init__(self, num_blocks,num_classes,width_multiplier=None, override_groups_map=None, use_se=False):
        ...
        self.stage0 = RepVGGBlock(in_channels=3, out_channels=self.in_planes, kernel_size=3, stride=2, padding=1, use_se=self.use_se)
